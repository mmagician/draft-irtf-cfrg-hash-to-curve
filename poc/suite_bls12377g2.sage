...
def bls12377g2_svdw(suite_name, is_ro):
    ...
    return BasicH2CSuiteDef("BLS12-377 G2", F, A, B, expander, hashlib.sha256, 64, GenericSvdW, h_eff, k, is_ro, expander.dst)
...
assert bls12377g2_sswu_ro.m2c.Z == bls12377g2_sswu_nu.m2c.Z == F(-2 - II)
assert bls12377g2_svdw_ro.m2c.Z == bls12377g2_svdw_nu.m2c.Z == F(-1)
